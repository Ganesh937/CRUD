...
if(isset($_POST['submit'])){
    ...
    // insert query
    $sql="insert into `phpcrud` (username,email,mobile,address) values ('$username',
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="number" placeholder="Enter your number" required autocomplete="off" name="mobile">
